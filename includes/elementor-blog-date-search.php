...
class LNC_Blog_Date_Search_Widget extends \Elementor\Widget_Base {
	...
	private function register_style_controls() {
		...
		$this->add_control( 'field_border', [ 'label' => esc_html__( 'Field Border Color', 'legal-nurse-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'default' => '#e6e2d8', 'selectors' => [ '{{WRAPPER}} .lnc-datesearch__field input' => 'border-color:{{VALUE}};' ] ] );
		$this->add_responsive_control( 'field_padding', [ 'label' => esc_html__( 'Field Padding', 'legal-nurse-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', 'em' ], 'selectors' => [ '{{WRAPPER}} .lnc-datesearch__field input' => 'padding:{{TOP}}{{UNIT}} 44px {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
		$this->add_control( 'field_radius', [ 'label' => esc_html__( 'Field Radius', 'legal-nurse-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 0, 'max' => 40 ] ], 'default' => [ 'size' => 10, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .lnc-datesearch__field input' => 'border-radius:{{SIZE}}{{UNIT}};' ] ] );
